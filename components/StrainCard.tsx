      ...
      <div onClick={onClick} className="bg-gradient-to-br from-white to-surface-highlight border border-white/50 rounded-[1.5rem] p-6 shadow-soft relative overflow-hidden">
         <div className="flex justify-between items-start mb-4">
            ...
            <div className="text-right">
               <div className="flex items-center justify-end gap-1 text-primary font-black text-lg"><Zap size={14} /> {strain.thc_level}</div>
               <div className="text-[9px] font-bold text-gray-400">Estimated THC percentage</div>
            </div>
         </div>
         ...
         <div className="flex items-center gap-3">
            ...
            <span className="text-xs font-bold text-text-main">{strain.most_common_terpene}</span>
            <span className="text-[9px] font-medium text-gray-400">Terpene present</span>
         </div>
      </div>
   );
};
