    ...
    <div className="min-h-screen bg-surface text-text-main relative overflow-hidden flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 z-10 relative pt-8 pb-4 overflow-y-auto no-scrollbar">
        ...
        <img 
            ...
            className="w-20 h-20 mb-8 drop-shadow-lg"
        />
        ...
        <div className="flex flex-col items-center max-w-md text-center">
            ...
            {/* Headline - Larger to fit ~3 lines on mobile */}
            <h1 className="text-5xl font-extrabold leading-[1.1] tracking-tight text-text-main mb-6">
                Your Personal AI <br/>
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-neon-blue">Grow Coach</span>
            </h1>
            
            {/* Sub-headline */}
            <p className="text-lg font-medium text-text-sub leading-relaxed px-1 mb-8">
