...
const PostPaymentAuth: React.FC<PostPaymentAuthProps> = ({ onComplete, userProfile }) => {
  ...
  return (
    <div className="h-screen bg-surface relative flex flex-col items-center justify-center p-6 animate-in fade-in duration-500 overflow-y-auto no-scrollbar">
      ...
      <div className="w-full max-w-md bg-white rounded-[2rem] p-8 shadow-card border border-gray-100 relative z-10 text-center">
          ...
          <div className="space-y-3 mb-6">
            <button 
                ...
                className="w-full bg-black text-white font-bold text-base py-3.5 rounded-2xl shadow-lg flex items-center justify-center gap-3 active:scale-[0.98] transition-transform"
            >
            ...
            <button 
                ...
                className="w-full bg-white text-text-main border border-gray-200 font-bold text-base py-3.5 rounded-2xl shadow-sm flex items-center justify-center gap-3 active:scale-[0.98] transition-transform hover:bg-gray-50"
            >
                <img 
          ...
          <div className="relative mb-6">
             ...
             <div className="relative flex justify-center text-[10px] uppercase font-black text-gray-400 tracking-widest"><span className="bg-white px-3">OR CONTINUE WITH</span></div>
          </div>
            ...
            <div>
                ...
                <div className="relative">
                    ...
                    <input 
                        ...
                        className="w-full bg-gray-50 border border-gray-100 rounded-xl pl-12 pr-4 py-3.5 text-sm font-bold text-text-main focus:ring-2 focus:ring-primary/20 outline-none placeholder-gray-300"
                    />
                </div>
            </div>
            <div>
          ...
          <div className="grid grid-cols-2 gap-3 mb-2">
            <button 
                ...
                className="bg-white text-text-main border border-gray-200 font-bold py-3.5 rounded-2xl shadow-sm flex items-center justify-center gap-2 active:scale-95 transition-transform"
            >
                <LogIn size={18} /> Sign In
            </button>
            <button 
                onClick={handleSignUp}
                className="bg-primary text-white font-bold py-3.5 rounded-2xl shadow-lg flex items-center justify-center gap-2 active:scale-95 transition-transform"
            >
                <UserPlus size={18} /> Sign Up
            </button>
          </div>

          <div className="mt-8 flex items-center justify-center gap-1.5 text-[10px] text-text-sub opacity-70">
              <Lock size={12} />
