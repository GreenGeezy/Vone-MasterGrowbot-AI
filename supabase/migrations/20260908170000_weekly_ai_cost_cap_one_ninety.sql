-- Product decision: raise the authoritative rolling seven-day AI budget to
-- $1.90 while preserving the five-video daily limit and atomic admission.
...
begin
  ...
  if v_weekly + p_reserved_cost_usd > 1.90 then
