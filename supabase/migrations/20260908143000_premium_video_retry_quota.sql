-- Allow one initial video request and one retry per day. The $0.90 rolling
-- weekly reservation remains authoritative and can stop requests earlier.
...
begin
  ...
  if p_count_request and p_mode = 'video_visual_analysis' and v_video >= 2 then
