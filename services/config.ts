...
export const CONFIG = {
    ...
    // FIXED: Switched to Stable Production Models to prevent "No Response" errors
    MODELS: {
        DIAGNOSIS: 'gemini-1.5-pro', // Best for Vision/Image Analysis (High Accuracy)
        CHAT_LIVE: 'gemini-1.5-flash', // Best for Text/Chat (Fastest Response)
        INSIGHTS: 'gemini-1.5-flash', // Efficient for daily summaries      
    },

    // FIXED: Force the Custom Domain to prevent browser flashes
    SUPABASE_URL: 'https://auth.mastergrowbotai.com',
    
    // Auth Key with Fallback
